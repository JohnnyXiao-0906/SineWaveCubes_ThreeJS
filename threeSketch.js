...
function init() {
    ...
    const diffuseColor = new THREE.Color("rgb(255, 127, 180)");
    ...
    mat.add(material, 'clearcoat', 0, 1); 
    mat.add(material, 'wireframe', false, true); 
    mat.add(material, 'vertexColors', false, true); 
...
function render(){
    ...
    for (let i = 0; i < cubes.length; i++) {
        ...
        let n = Noise.noise(cube.position.x * 0.2 +clock.getElapsedTime(), cube.position.y*0.1 , cube.position.z*0.1+clock.getElapsedTime());
        cube.scale.y = 1+n*10;
